package br.app.modulo.infra.comparator;
...
public class ModuleDescriptionComparator implements Comparator<FluidGridItem> {
	 ...
	 *
	 * @param mod1
	 *            the first module to be compared.
	 * @param mod2
	 *            the second module to be compared.
	 * @return a negative integer, zero, or a positive integer as the first
	 *         argument is less than, equal to, or greater than the second.
	 */
	@Override
	public int compare(FluidGridItem mod1, FluidGridItem mod2) {
		return ((ModuleDescription) mod1.getData()).getName()
				.compareToIgnoreCase(((ModuleDescription) mod2.getData()).getName());
	}
}
